...
\resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
      ...
      \hline
    \end{tabular}}
    \caption{Experiments setup, defined by: test name, receptive field of the feature extraction backbone, patch size, input image size after scaling up, anchors size and ratio, normalization of the gray level values, whether focal loss or balancing were used.}
